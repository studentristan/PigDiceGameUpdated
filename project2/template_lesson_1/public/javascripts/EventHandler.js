  ...
  handleRollPress() {
    document.getElementById('roll').addEventListener('click', (event) => {
      ...
      if (this.#turnCounter === 1) {
        ...
        console.log(`Player 1 Roll #1 is: ${this.#roll1}`);
        ...
        console.log(`Player 1 Roll #2 is: ${this.#roll2}`);
        ...
        if (this.#roll1 + this.#roll2 * 1 === 2) {
          ...
          console.log(`Turn Counter is currently ${this.#turnCounter}`);
          this.winTheGame();
          ...
          this.#turnTotal = this.#turnTotal * 2;
          console.log(`this turn you got doubles! Turn Total is now ${this.#turnTotal}`);
          this.#p1Total = this.#turnTotal + this.#p1Total;
          document.getElementById('p1total').innerHTML = `${this.#p1Total}`;
          console.log(`doubles! Yay!`);
          console.log(`p1 total = ${this.#p1Total}`);
          console.log(`Turn Counter is currently ${this.#turnCounter}`);
          this.winTheGame();
        } else {
